...
func _on_NewExtension_about_to_show() -> void:
	$PanelContainer/VBoxContainer/Save/path.text = ProjectSettings.globalize_path("res://")


func _on_Name_text_changed(new_text: String) -> void:
	if new_text == "":
		extension_json.name = $PanelContainer/VBoxContainer/Name/LineEdit.placeholder_text
	else:
...
func _on_DisplayName_text_changed(new_text: String) -> void:
	if new_text == "":
		extension_json.display_name = $PanelContainer/VBoxContainer/DisplayName/LineEdit.placeholder_text
	else:
...
func _on_Description_text_changed(new_text: String) -> void:
	if new_text == "":
		extension_json.description = $PanelContainer/VBoxContainer/Description/LineEdit.placeholder_text
	else:
...
func _on_Author_text_changed(new_text: String) -> void:
	if new_text == "":
		extension_json.author = $PanelContainer/VBoxContainer/Author/LineEdit.placeholder_text
	else:
...
func _on_Choose_pressed() -> void:
	...
	$FileDialog.current_dir = $PanelContainer/VBoxContainer/Save/path.text


func _on_FileDialog_dir_selected(dir: String) -> void:
	$PanelContainer/VBoxContainer/Save/path.text = dir


func _on_NewExtension_confirmed() -> void:
	var save_path = $PanelContainer/VBoxContainer/Save/path.text
...
# warning-ignore:return_value_discarded
	...
	file.store_string($Hidden/ApiVersions.get_child($PanelContainer/VBoxContainer/ApiLevel/Api.selected).text)
	file.close()
# warning-ignore:return_value_discarded
